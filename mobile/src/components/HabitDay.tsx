...
export function HabitDay({ amountOfHabits = 0, amountCompleted = 0, date, ...rest }: Props) {
    ...
    return(
        <TouchableOpacity
            //como clsx você pode ciar condições para o uso das classes de estilizações do css
            className={clsx("rounded-lg border-2 m-1", {
                ["bg-zinc-800 border-zinc-700"] : amountAccomplishedPercentage == 0,//aplica esse estilos quando amountAccomplishedPercentage for == 0
                ...
                ["border-white border-r-4"] : isCurrentDay //dar um destaque branco ao quadradinho do dia atual 
            })}
